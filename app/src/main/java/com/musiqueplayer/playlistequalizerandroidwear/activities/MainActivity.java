...
import com.musiqueplayer.playlistequalizerandroidwear.MusicPlayer;
import com.musiqueplayer.playlistequalizerandroidwear.R;
import com.musiqueplayer.playlistequalizerandroidwear.TimeService;
import com.musiqueplayer.playlistequalizerandroidwear.fragments.AlbumDetailFragment;
import com.musiqueplayer.playlistequalizerandroidwear.fragments.ArtistDetailFragment;
import com.musiqueplayer.playlistequalizerandroidwear.fragments.FoldersFragment;
import com.musiqueplayer.playlistequalizerandroidwear.fragments.MainFragment;
import com.musiqueplayer.playlistequalizerandroidwear.fragments.PlaylistFragment;
import com.musiqueplayer.playlistequalizerandroidwear.fragments.QueueFragment;
import com.musiqueplayer.playlistequalizerandroidwear.fragments.TimerFragment;
import com.musiqueplayer.playlistequalizerandroidwear.permissions.Nammu;
import com.musiqueplayer.playlistequalizerandroidwear.permissions.PermissionCallback;
import com.musiqueplayer.playlistequalizerandroidwear.slidinguppanel.SlidingUpPanelLayout;
...
import com.musiqueplayer.playlistequalizerandroidwear.utils.TimberUtils;
...
public class MainActivity extends BaseActivity implements ATEActivityThemeCustomizer {
    ...
    Runnable navigateTimer = new Runnable() {
        public void run() {
            navigationView.getMenu().findItem(R.id.nav_timer).setChecked(true);
    ...
    private void setupNavigationIcons(NavigationView navigationView) {
        ...
        if (!isDarkTheme) {
            ...
            navigationView.getMenu().findItem(R.id.nav_timer).setIcon(R.drawable.clock);
            ...
            case R.id.nav_about:
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        final AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(new ContextThemeWrapper(MainActivity.this, R.style.myDialog));

                        final SpannableString s = new SpannableString(Html.fromHtml("Thanks for downloading Music Player.<br>" +
    ...
    public void setDetailsToHeader() {
        ...
        /*ImageLoader.getInstance().displayImage(TimberUtils.getAlbumArtUri(MusicPlayer.getCurrentAlbumId()).toString(), albumart,
                new DisplayImageOptions.Builder().cacheInMemory(true)
                        .showImageOnFail(R.drawable.icons)
    ...
    private boolean isNavigatingMain() {
        ...
        return (currentFragment instanceof MainFragment || currentFragment instanceof QueueFragment ||
                currentFragment instanceof TimerFragment  || currentFragment instanceof PlaylistFragment || currentFragment instanceof FoldersFragment);
    }
