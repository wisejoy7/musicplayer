...
package com.musiqueplayer.playlistequalizerandroidwear.adapters;
...
import com.musiqueplayer.playlistequalizerandroidwear.dialogs.AddPlaylistDialog;
...
import com.musiqueplayer.playlistequalizerandroidwear.widgets.BubbleTextGetter;
import com.musiqueplayer.playlistequalizerandroidwear.widgets.MusicVisualizer;
...
public class SongsListAdapter extends RecyclerView.Adapter<SongsListAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    public void onBindViewHolder(ItemHolder itemHolder, int i) {
        ...
        ImageLoader.getInstance().displayImage(TimberUtils.getAlbumArtUri(localItem.albumId).toString(), itemHolder.albumArt, new DisplayImageOptions.Builder().cacheInMemory(true).showImageOnFail(R.drawable.icons).resetViewBeforeLoading(true).build());
